...
from client_notes.cli import main
from client_notes.models import Note, ProjectState, Task
from client_notes.cli import demo_state
from client_notes.storage import load_state, save_state
from client_notes.models import generate_short_id
from client_notes.validation import normalize_tags, require_text, validate_task_status
from client_notes.services import (
    create_note,
    list_notes,
    get_note,
    update_note,
